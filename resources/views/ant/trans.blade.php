...
<x-app-layout>
    <x-slot name="header">
        ...
        <p>See your choices of transport in Muar </p>
    </x-slot>
                ...
                <div class="container">
                    <div class="rectangle"> <!--filter -->
                        <div class="image-placeholder">
                            @if($transportation->trans_img)
                            <img src="{{ url('/storage/' . $transportation->trans_img) }}" alt="Transportation Image">
                            @endif
                        </div>
                        ...
                        <div class="attraction-desc">
                            <p>{{ $transportation->trans_sdesc }}</p>
                        </div>
                    </div>
                </div>
